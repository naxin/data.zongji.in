...
//								}
				...
				// searchget
                    ...
                    if (prep[3]) {
						...
						sfu.closePopup();
                        //spsupport.log("sp.sgDualResults = " + sp.sgDualResults + ";  sp.prodPage.p = " + sp.prodPage.p);
                        if (similarproducts.utilities.abTestUtil && similarproducts.utilities.abTestUtil.getBucket && similarproducts.utilities.abTestUtil.getBucket() == '2014w12_InImgSerget_Ebay' && sp.sgDualResults && sp.prodPage.p) {
                            if (prep[6] && !similarproducts.inimg.hasTemplate()) {
                                similarproducts.Template.initialize(prep[6]);
					}
                            similarproducts.inimg.init(prep[3], +prep[4], sfu, spsupport.p, similarproducts.b, sp.prodPage.p);
...
//            if (testLangs.indexOf('|' + similarproducts.b.userData.lang + '|') == -1 || similarproducts.utilities.abTestUtil.getBucket() != 'uiCoreLocalized_A') {    //language not in test
			...
			if (!spsupport.sites.isBlackStage()) {
				...
				if (similarproducts.utilities.abTestUtil.getBucket() == '2014w12_Additional_InImg_Offer' || similarproducts.utilities.abTestUtil.getBucket() == 'uiRedesign01LT_A')
				{
...
//            spsupport.log(sp.SRP);
		...
		addSeeMoreButton: function()
		{
			...
			{
				case '2014w12_See_More_Blue_UI4_h40-p14':
					button.addClass('ab1');
					break;
				case '2014w12_See_More_Blue_1_h40-p9':
					button.addClass('ab1 t1');
					break;
				case '2014w12_See_More_Blue_2_h36-p6':
					button.addClass('ab1 t2');
					break;
				case '2014w12_See_More_Blue_4_h32-p8':
					button.addClass('ab1 t4');
					break;
				case '2014w12_See_More_Orange_UI4_h40-p14':
					button.addClass('ab2');
					break;
				case '2014w12_See_More_Orange_1_h40-p9':
					button.addClass('ab2 t1');
					break;
				case '2014w12_See_More_Orange_2_h36-p6':
					button.addClass('ab2 t2');
					break;
				case '2014w12_See_More_Orange_4_h32-p8':
					button.addClass('ab2 t4');
					break;
			}
		...
		addAn: function(){
			...
			if(!sp.sfIcon.an)
			{
				...
				if ('2014w12_See_More_Blue_UI4_h40-p14|2014w12_See_More_Blue_1_h40-p9|2014w12_See_More_Blue_2_h36-p6|2014w12_See_More_Blue_4_h32-p8|2014w12_See_More_Orange_UI4_h40-p14|2014w12_See_More_Orange_1_h40-p9|2014w12_See_More_Orange_2_h36-p6|2014w12_See_More_Orange_4_h32-p8'.search(similarproducts.utilities.abTestUtil.getBucket()) > -1)
				{
